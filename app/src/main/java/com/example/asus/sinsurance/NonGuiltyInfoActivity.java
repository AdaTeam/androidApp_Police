...
public class NonGuiltyInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_non_guilty_info);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "http://thingtalk.ir/update?key=O2A2ONLQXBTD858Y&field1="+SerialClass.Serial
                ...
                Intent i = new Intent(getApplicationContext() , KrookiLocationInfoActivity.class);
                startActivity(i);
                finish();
            }
        });
